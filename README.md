...
1. Send a request
        ...
        $ CURL_CA_BUNDLE=/home/keith/code/tls/root_server_cert.pem curl https://keithcullen.net/v1/get?name=Bob
...
2. Run the test suite
        ...
        $ REQUESTS_CA_BUNDLE=/home/keith/code/tls_web/root_server_cert.pem robot test.robot
...
3. Configure a request
        ...
        replace '{{baseUrl}}' with 'http://keithcullen.net:8080'
        select 'Params'
        set 'name' to 'Bob'
        select 'Scripts'
        paste
